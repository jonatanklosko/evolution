...
public class SimulationTest {
  ...
  public void removeDeadAnimalsShouldRemoveDeadAnimalsFromMap() {
    ...
    Animal aliveAnimal = new Animal(new Vector2d(0, 0), 1, 5, dateControl);
    map.addElement(aliveAnimal);
    map.addElement(new Animal(new Vector2d(0, 0), 0, 5, dateControl));
    map.addElement(new Animal(new Vector2d(0, 0), -1, 5, dateControl));
  ...
  public void eatPrioritizesAnimalWithHighestEnergy() {
    Simulation simulation = new Simulation(SimulationTest.params);
    IWorldMap map = simulation.getMap();
    Animal animal1 = new Animal(new Vector2d(0, 0), 5, 5, dateControl);
    Animal animal2 = new Animal(new Vector2d(0, 0), 15, 5, dateControl);
    Animal animal3 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    Plant plant = new Plant(new Vector2d(0, 0), 10);
  ...
  public void eatSplitsPlantEnergyIfManyAnimalsHaveMaxEnergy() {
    Simulation simulation = new Simulation(SimulationTest.params);
    IWorldMap map = simulation.getMap();
    Animal animal1 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    Animal animal2 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    Plant plant = new Plant(new Vector2d(0, 0), 10);
    map.addElement(animal1);
    map.addElement(animal2);
    map.addElement(plant);
  ...
  public void reproduceDoesNotReproduceIfAnimalsDoNotHaveSufficientEnergy() {
    Simulation simulation = new Simulation(SimulationTest.params);
    IWorldMap map = simulation.getMap();
    Animal animal1 = new Animal(new Vector2d(0, 0), 10, 20, dateControl);
    Animal animal2 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    map.addElement(animal1);
    map.addElement(animal2);
    simulation.reproduce();
  ...
  public void generatePlantsDoesNotAddPlantsIfTheMapIsFull() {
    ...
    IWorldMap map = simulation.getMap();
    Animal animal1 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    Animal animal2 = new Animal(new Vector2d(0, 1), 10, 5, dateControl);
  ...
  public void livingGenomesIgnoresDeadAnimals() {
    Simulation simulation = new Simulation(SimulationTest.params);
    IWorldMap map = simulation.getMap();
    Animal animal1 = new Animal(new Vector2d(0, 0), 0, 5, dateControl);
    Animal animal2 = new Animal(new Vector2d(0, 0), 10, 5, dateControl);
    Animal animal3 = new Animal(new Vector2d(0, 0), -2, 5, dateControl);
    map.addElement(animal1);
    map.addElement(animal2);
    map.addElement(animal3);
